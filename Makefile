...
TOOLS=/usr/local/arm-none/bin

# variables 
CC      = $(TOOLS)/arm-elf-gcc
LD      = $(TOOLS)/arm-elf-ld -v
AR      = $(TOOLS)/arm-elf-ar
AS      = $(TOOLS)/arm-elf-as
CP      = $(TOOLS)/arm-elf-objcopy
OD		= $(TOOLS)/arm-elf-objdump
...
clean:
	-rm -r $(OBJECTS) crt.lst main.lst main.out main.bin main.hex main.map main.dmp
